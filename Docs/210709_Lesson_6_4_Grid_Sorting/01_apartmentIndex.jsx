...
class ApartmentIndex extends React.Component {
    ...
    handleTableChange(pagination, filters, sorter) {
        this.props.getApartments(pagination, sorter, this.props.minPrice, this.props.maxPrice, this.props.addressPart);
    }
...
let mapActionsToProps = (dispatch) => {
    return {
        getApartments: (pagination, sorting, minPrice, maxPrice, addressPart) =>
            dispatch(getApartments(pagination, sorting, minPrice, maxPrice, addressPart)),
