...
class ApartmentRead extends React.Component {
    componentDidMount() {
        ...
        document.title = "React Realty Course - Apartment #" + id;
                ...
                <Row>
                    ...
                    <Col span={20}>
                        <Descriptions bordered column={2}>
                            ...
                            <Descriptions.Item label="House ID in DB:">{apartmentInfo.houseId}</Descriptions.Item>
                            <Descriptions.Item label="Address:">{apartmentInfo.houseAddress}</Descriptions.Item>

                            <Descriptions.Item label="Price:">{apartmentInfo.price}</Descriptions.Item>
                            <Descriptions.Item label="Floor:">{apartmentInfo.floor} of {apartmentInfo.houseMaxFloor}</Descriptions.Item>
                        </Descriptions>
                    </Col>
                </Row>
