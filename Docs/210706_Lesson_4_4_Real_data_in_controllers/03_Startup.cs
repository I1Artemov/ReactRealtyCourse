...
namespace ReactRealtyCourse.Frontend
{
    public class Startup
    {
        ...
        {
            var connectionString = Configuration.GetConnectionString("ReactRealtyContext");

            services.AddDbContext<ReactRealtyContext>(options => options.UseSqlServer(connectionString));
